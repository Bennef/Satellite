...
namespace Scripts.Camera
{
    public class CameraZoom : MonoBehaviour
    {
        ...
        public Transform SpaceShip { get => _spaceShip; set => _spaceShip = value; }
        public Transform Barycenter { get => _barycenter; set => _barycenter = value; } // Currently set to Planet 1 - change later
